// valdiv_n1@216f:Hadoop$ gcc -c testing.c -o test.o -std=c11 -lpthread
// valdiv_n1@216f:Hadoop$ gcc -c query_wiki.c -o queryWiki.o -std=c11 -lcurl
// valdiv_n1@216f:Hadoop$ gcc -o program test.o queryWiki.o -lpthread -lcurl
// valdiv_n1@216f:Hadoop$ ./program
